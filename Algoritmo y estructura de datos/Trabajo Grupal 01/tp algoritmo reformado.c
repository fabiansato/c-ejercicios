...
{
    system ("COLOR 3F");
	int totalentradasn1=0,totalentradasn2=0,totalentradasn3=0,
	totalentradast1=0,totalentradast2=0,totalentradast3=0,
	cantentradast1=0,cantentradast2=0,cantentradast3=0,
	cantentradasn1=0,cantentradasn2=0,cantentradasn3=0,
	entradanoche=60,precioentrada=60,venta,promoprecion=0,
	promopreciot=0,totalpromo=0,turno=0,compra=0,asientos=0,
	precio=0,cantidadtotal2turnos=0,entradas=0,
	totalturnonoche=0,totalturnotarde=0,totalpromotarde=0;
	char diapromot[20] ,diapromon[20];
	leer_un_turno (turno);
	funcion_menu ();
	scanf ("%d",&turno);
	while(turno<3)
